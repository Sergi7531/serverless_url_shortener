...
BASE_URL = os.getenv("BASE_URL", "https://short.ly/")  # Replace with your domain
...
def lambda_handler(event, context):
    try:
        ...
        if not original_url:
            return _lambda_response(HTTPStatus.BAD_REQUEST)
...
def _lambda_response(status_code: HTTPStatus, message: str | None = None) -> dict:
